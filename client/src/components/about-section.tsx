        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12 items-center">
          <div className="order-2 lg:order-1">
            ...
            <p className="text-base sm:text-lg text-gray-700 mb-4 sm:mb-6 leading-relaxed">
              For over two decades, JJ Enterprises has been crafting exceptional pieces that transform houses into homes. Founded in 2003 by James and Julia Johnson, our company began with a simple vision: to create furniture that combines timeless design with contemporary functionality.
            </p>
